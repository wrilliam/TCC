...
# Second metric: pace
if tempo < 52: pace = 'broadly slow'
  else
  if tempo < 76: pace = 'slow'
  else
  if tempo < 100: pace = 'moderately slow'
  else
  if tempo < 112: pace = 'somewhat fast'
  else
  if tempo < 138: pace = 'fast'
  else
  if tempo < 143: pace = 'fast & lively'
  else
  if tempo < 188: pace = 'very fast'
